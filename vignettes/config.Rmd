...
Before you can use `rfacts` to simulate trials in R, you must specify the paths to all these executable files in a CSV file. You can see an example CSV file at [`inst/example_paths.csv`](https://github.com/EliLillyCo/rfacts/blob/master/inst/example_paths.csv) in the `rfacts` package source.
